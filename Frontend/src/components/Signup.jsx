...
const Signup = () => {
  ...
  return (
    <div className="h-screen flex items-center justify-center">
      <div
        id="login_modal"
        className="bg-white border-2 border-pink-500 rounded-lg shadow-lg max-w-md w-full p-6"
        open
...
<br />
            ...
            <div className="mt-12">
              <p>Have an Account? <span><Link to="/login" className="underline text-blue-500" >Login</Link></span></p>
            </div>
            </div>
          </form>
        </div>
